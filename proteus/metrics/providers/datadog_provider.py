...
class DatadogMetricsProvider(MetricsProvider):
    ...
    def set(
        self, metric_name: str, metric_value: Union[str, int, float], tags: Optional[Dict[str, str]] = None
    ) -> None:
        statsd.set(metric=metric_name, value=metric_value, tags=convert_datadog_tags(tags))

    def histogram(
        self, metric_name: str, metric_value: Union[int, float], tags: Optional[Dict[str, str]] = None
    ) -> None:
