...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
                ((FilterField(TEST_ENTITY_SCHEMA.col_a) == "test")
                 | (FilterField(TEST_ENTITY_SCHEMA.col_b) == "other")) & (FilterField(TEST_ENTITY_SCHEMA.col_c) == 1),
                ((pyarrow_field("col_a") == "test") | (pyarrow_field("col_b") == "other")) & (
                        pyarrow_field("col_c") == 1),
        ...
        (
                (
                        ...
                        (FilterField(TEST_ENTITY_SCHEMA.col_c) == 1) |
                        (FilterField(TEST_ENTITY_SCHEMA.col_b) == "other") &
                        ((FilterField(TEST_ENTITY_SCHEMA.col_c) == 2) |
                         (FilterField(TEST_ENTITY_SCHEMA.col_d).isin([1, 2])))
                ),
                (
                        (pyarrow_field("col_a") == "test") &
                        (pyarrow_field("col_c") == 1) |
                ...
                (
                        [{'col_a': 'test', 'col_c': 1}, {'col_b': 'other', 'col_c': 2},
                         {'col_b': 'other', 'col_d__in': [1, 2]}]
                ),
        )
    ],
)
