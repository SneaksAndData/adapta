...
class FilterField:
    ...
    def __eq__(self, values: object) -> "Expression":
        """
    ...
    def __ne__(self, values: object) -> "Expression":
        """
