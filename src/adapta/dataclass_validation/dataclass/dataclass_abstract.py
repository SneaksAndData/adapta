...
class AbstractDataClass(CoreDataClass):
    ...
    def validate_and_collect_data(
        self, data: Any, settings: list[str] | None = None, add_non_required_fields: bool = False
    ) -> ValidationResponse:
        """
        Method for validating the data against the schema.
    ...
    def validate_data(self, data: Any, settings: list[str] | None = None, add_non_required_fields: bool = False) -> Any:
        """
        Method for validating the data against the schema.
