...
class Field:
    ...
    def __init__(
        ...
        required: bool = True,
        required_by_settings: list[str] | None = None,
        coerce: bool = False,
        add_field_if_missing: bool = False,
        checks: Checks | None = None,
        allow_missing_values: bool = False,
        astra_properties: AstraProperties | None = None,
        ...
        if (self.checks is not None and self.dtype not in [int, float, list[int], list[float]]) and (
            self.checks.le_value is not None or self.checks.ge_value is not None
        ):
            raise ValueError("Field checks can only be applied to numeric fields (int, float, list[int], list[float]).")
...
class CoreDataClass:
    ...
    def get_required_columns(self, settings: list[str] | None = None) -> list[str]:
        """
    ...
    def get_required_column_types(self, settings: list[str] | None = None) -> dict[str, type]:
        """
